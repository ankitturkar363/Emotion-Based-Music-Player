...
happy_playlist = ["WillPharrell-Happy", "Kool&TheGang-Celebration", "RickAstley-NeverGonnaGiveYouUp","Dance_Monkey","Apna_Har_Din","Kudi-Gujarat-Di"];
happy_title = ["Will Pharrell - Happy", "Kool & The Gang - Celebration", "Rick Astley - Never Gonna Give You Up","Dance Monkey-Tones and I","Apna Har din-Golmaal3","Kudi Gujarat Di-Sweetiee Weds NRI"];
happy_poster = ["static/song_imgs/happy.jpg", "static/song_imgs/celebration.jpg", "static/song_imgs/never_gonna_give_you_up.jpg","static/song_imgs/dance-monkey.jpg","static/song_imgs/apna hardin.jpg","static/song_imgs/kudi gujarat di.jpg"];

calm_playlist = ["SmashMouth-AllStar", "DJOkawari-SpeedofLight", "BillieEilish-BadGuy","Life-goes-on","Ilahi-Full-Song","Naina-Da-Kya-Kasoor"];
calm_title = ["Smash Mouth - All Star", "DJ Okawari - Speed of Light", "Billie Eilish - Bad Guy","life goes on-Oliver tree","Ilahi-Yeh Jawaani Hai Deewani","Naina Da Kya Kasoor-AndhaDhun"];
calm_poster = ["static/song_imgs/all_star.jpeg", "static/song_imgs/speed_of_light.jpg", "static/song_imgs/bad_guy.jpg","static/song_imgs/life goes on.jpg","static/song_imgs/ilahi.jpg","static/song_imgs/naina da kya kasoor.jpg"];

sad_playlist = ["Adele-Hello", "CelineDion-MyHeartWillGoOn", "GaryJules-MadWorld", "Noor-E-Khuda","ROOH-OFFICIAL","Agar_Tum_Saath_Ho"];
sad_title = ["Adele - Hello", "Celine Dion - My Heart Will Go On", "Gary Jules - Mad World","Noor_E_Khuda - My name is khan","Rooh Official Music","Agar Tum sath ho-Full song"];
sad_poster = ["static/song_imgs/hello.JPG", "static/song_imgs/my_heart_will_go_on.jpg", "static/song_imgs/mad_world.jpg","static/song_imgs/noor-e-khuda.jpg","static/song_imgs/rooh-tej-gill-mp3-song.jpg","static/song_imgs/agar tum sath ho.jpg"];
